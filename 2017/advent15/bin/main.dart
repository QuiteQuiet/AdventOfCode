class Generator {
  ...
  String next() {
    ...
    return this.prev.toRadixString(2).padLeft(32, '0');
  }
}
...
void main() {
  ...
  Generator a = new Generator(783, 16807),
  b = new Generator(325, 48271);
  int pairs1 = 0, pairs2 = 0;

  // part 1
  for (int i = 0; i < 40000000; i++) {
    String nexta = a.next().substring(16);
    String nextb = b.next().substring(16);
    if (nexta == nextb) pairs1++;
  }
